...
//		Interesting vertices file
		...
		lblInterestingVertices.setToolTipText(
				"Location of the nodes of interest file (optional - leave blank for frequent subgraph mining)");
...
//		undirected network checkbox
		...
		checkBoxUndirected.setToolTipText(
				"Treat the network as undirected, e.g. where A -> B = B -> A and self-loops aren't allowed.");
...
//		Advanced options
		...
		labelSupport.setToolTipText("Support value threshold to use (leave empty for automatic calculation).");
...
//		Output files panel
		...
		outputPanel
				.setBorder(new TitledBorder(null, "Output files", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		labelSavePath.setToolTipText(
				"Output file location. The visualisation file will be stored under the same name, but with a .html extension.");
...
//		Define report panel
		...
		panelReport.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Log",
