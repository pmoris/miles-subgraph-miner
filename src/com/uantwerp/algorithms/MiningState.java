...
public abstract class MiningState {
	/*
	 * This class will store all checked subgraphs. This class will contain all
	 * subgraphs for which the significance has been calculated. In other words, all
	 * subgraphs that have passsed the pruning algorithm
	 */

	// Contains the motifs that have been checked in the group of interest alongside
	// their support/frequency,
	...
	// in the form of motif string representations mapping to probabilities (p-value
	...
	// Stores the number of subgraphs whose raw p-value meets the unadjusted p-value
	// threshold
	...
	// Contains motifs that meet the support threshold,
	// in the form of motif string representations mapping to support/frequency in
	// the entire graph
